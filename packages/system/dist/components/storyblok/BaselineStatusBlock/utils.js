export function getStatusDisplay(status, lowDate) {
    switch (status) {
        case "widely":
            return {
                label: "Widely available",
                description: "This feature is well established and works across many devices and browser versions.",
                badgeText: null,
                color: "green",
            };
        case "newly":
            return {
                ...
                description: "Since this date, this feature works across the latest devices and browser versions. This feature might not work in older devices or browsers.",
