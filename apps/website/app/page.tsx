      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <main>
          ...
          <section>
            ...
            <Card padding="lg">
              <Text>
                Our design tokens provide a consistent foundation for colors,
                spacing, typography, and more. They ensure visual consistency
                across all gotpop projects.
              </Text>
              <div
                style={{
                  marginTop: spacing[4],
              ...
              >
                <Button variant="primary">View Tokens</Button>
                <Button variant="secondary">Guidelines</Button>
              </div>
            </Card>
          </section>
        </main>
