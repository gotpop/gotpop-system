...
console.log(
  "🔄 Converting custom elements to standard HTML elements for JSR compatibility...\n"
)
...
tsxFiles.forEach((filePath) => {
  try {
    ...
    Object.entries(elementMappings).forEach(
      ([customElement, standardElement]) => {
...
console.log(
  "📝 Note: Custom elements have been replaced with semantic HTML elements."
)
